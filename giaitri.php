...
// Lấy danh mục "Giải trí" từ bảng categories
$category_name = 'Giải trí'; // Tên danh mục

// Lấy thông tin danh mục "Giải trí" từ cơ sở dữ liệu
...
// Truy vấn để lấy tổng số bài viết trong danh mục "Giải trí"
...
// Truy vấn để lấy bài viết trong danh mục "Giải trí" cho trang hiện tại
...
<main>
    <div class="container">
        <div class="row mb">
            <!-- Phần bài viết chính -->
            <div class="boxtrai">
                <h2>Bài Viết Giải Trí</h2>

                <?php
                // Hiển thị bài viết trong danh mục "Giải trí"
