...
// Lấy danh mục "Bất động sản" từ bảng categories
$category_name = 'Bất động sản'; // Tên danh mục

// Lấy thông tin danh mục "Bất động sản" từ cơ sở dữ liệu
...
// Truy vấn để lấy tổng số bài viết trong danh mục "Bất động sản"
...
// Truy vấn để lấy bài viết trong danh mục "Bất động sản" cho trang hiện tại
...
<main>
    <div class="container">
        <div class="row mb">
            <!-- Phần bài viết chính -->
            <div class="boxtrai">
                <h2>Bài Viết Bất Động Sản</h2>

                <?php
                // Hiển thị bài viết trong danh mục "Bất động sản"
