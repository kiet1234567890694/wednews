...
// Lấy danh mục "Kinh doanh" từ bảng categories
$category_name = 'Kinh doanh'; // Tên danh mục

// Lấy thông tin danh mục "Kinh doanh" từ cơ sở dữ liệu
...
// Truy vấn để lấy tổng số bài viết trong danh mục "Kinh doanh"
...
// Truy vấn để lấy bài viết trong danh mục "Kinh doanh" cho trang hiện tại
...
<main>
    <div class="container">
        <div class="row mb">
            <!-- Phần bài viết chính -->
            <div class="boxtrai">
                <h2>Bài Viết Kinh Doanh</h2>

                <?php
                // Hiển thị bài viết trong danh mục "Kinh doanh"
