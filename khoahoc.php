...
// Lấy danh mục "Khoa học" từ bảng categories
$category_name = 'Khoa học'; // Tên danh mục

// Lấy thông tin danh mục "Khoa học" từ cơ sở dữ liệu
...
// Truy vấn để lấy tổng số bài viết trong danh mục "Khoa học"
...
// Truy vấn để lấy bài viết trong danh mục "Khoa học" cho trang hiện tại
...
<main>
    <div class="container">
        <div class="row mb">
            <!-- Phần bài viết chính -->
            <div class="boxtrai">
                <h2>Bài Viết Khoa Học</h2>

                <?php
                // Hiển thị bài viết trong danh mục "Khoa học"
