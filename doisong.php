...
// Lấy danh mục "Đời sống"
$category_name = 'Đời sống'; // Tên danh mục

// Lấy thông tin danh mục "Đời sống" từ cơ sở dữ liệu
...
// Truy vấn để lấy tổng số bài viết trong danh mục "Đời sống"
...
// Truy vấn để lấy bài viết trong danh mục "Đời sống" cho trang hiện tại
...
<main>
    <div class="container">
        <div class="row mb">
            <!-- Phần bài viết chính -->
            <div class="boxtrai">
                <h2>Bài Viết Đời sống</h2>

                <?php
                // Hiển thị bài viết trong danh mục "Đời sống"
