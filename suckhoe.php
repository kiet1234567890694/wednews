...
// Lấy danh mục "Sức khỏe"
$category_name = 'Sức khỏe'; // Tên danh mục

// Lấy thông tin danh mục "Sức khỏe" từ cơ sở dữ liệu
...
// Truy vấn để lấy tổng số bài viết trong danh mục "Sức khỏe"
...
// Truy vấn để lấy bài viết trong danh mục "Sức khỏe" cho trang hiện tại
...
<main>
    <div class="container">
        <div class="row mb">
            <!-- Phần bài viết chính -->
            <div class="boxtrai">
                <h2>Bài Viết Sức khỏe</h2>

                <?php
                // Hiển thị bài viết trong danh mục "Sức khỏe"
