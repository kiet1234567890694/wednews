...
// Lấy danh mục "Thể thao" từ bảng categories
$category_name = 'Thể thao'; // Tên danh mục

// Lấy thông tin danh mục "Thể thao" từ cơ sở dữ liệu
...
// Truy vấn để lấy tổng số bài viết trong danh mục "Thể thao"
...
// Truy vấn để lấy bài viết trong danh mục "Thể thao" cho trang hiện tại
...
<main>
    <div class="container">
        <div class="row mb">
            <!-- Phần bài viết chính -->
            <div class="boxtrai">
                <h2>Bài Viết Thể Thao</h2>

                <?php
                // Hiển thị bài viết trong danh mục "Thể thao"
