...
// Lấy danh mục "Thế giới" từ bảng categories
$category_name = 'Thế giới'; // Tên danh mục

// Lấy thông tin danh mục "Thế giới" từ cơ sở dữ liệu
...
// Truy vấn để lấy tổng số bài viết trong danh mục "Thế giới"
...
// Truy vấn để lấy bài viết trong danh mục "Thế giới" cho trang hiện tại
...
<main>
    <div class="container">
        <div class="row mb">
            <!-- Phần bài viết chính -->
            <div class="boxtrai">
                <h2>Bài Viết Thế Giới</h2>

                <?php
                // Hiển thị bài viết trong danh mục "Thế giới"
